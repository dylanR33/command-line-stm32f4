...
void FMC_Handler()                    __attribute__( (weak, alias( "Default_Handler" ) ) );
...
void SAI2_Handler()                   __attribute__( (weak, alias( "Default_Handler" ) ) );
void QuadSPI_Handler()                __attribute__( (weak, alias( "Default_Handler" ) ) );
void HDMI_CEC_Handler()               __attribute__( (weak, alias( "Default_Handler" ) ) );
void SPDIF_RX_Handler()               __attribute__( (weak, alias( "Default_Handler" ) ) );
void FMPI2C1_Handler()                __attribute__( (weak, alias( "Default_Handler" ) ) );
void FMPI2C1_Error()                  __attribute__( (weak, alias( "Default_Handler" ) ) );
